...
function loadBackgroundSupportScripts( tab ){
	...
	chrome.tabs.executeScript(tab.ib, { file: 'lib/mapper.js' });
	chrome.tabs.executeScript(tab.ib, { file: 'lib/functional.js' });
	chrome.tabs.executeScript(tab.ib, { file: 'lib/curry.js' });
	chrome.tabs.executeScript(tab.ib, { file: 'lib/Bacon.js' });
